...
<body>
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.xadmin.net" class="navbar-brand"> Customer Payment Details (ElectroGrid) </a>
			</div>
				...
				<tbody>
					...
					<c:forEach var="user" items="${listUser}">
						...
						<tr>
							...
							<td><c:out value="${user.billNo}" /></td>
							<td><c:out value="${user.bankName}" /></td>
							<td><a href="edit?id=<c:out value='${user.id}' />">Update</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
